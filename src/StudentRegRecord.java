...
public class StudentRegRecord extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
PreparedStatement pst=null;

    /**
     * Creates new form StudentRegRecord
     */
    public StudentRegRecord() {
       initComponents();
 ...
 private void Get_Data(){
           String sql="select MatricNo as 'Matric Number', Fname as 'Name',Sname as 'Surname',Address,ContactNo as 'Contact No.',EmailID as 'Email ID',Age,Gender as 'Gender',Department as 'Department',Level from Studentregistration";
           try{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try{
            ...
            String sql= "select * from StudentRegistration where MatricNo = '" + table_click + "'";
            pst=con.prepareStatement(sql);
            rs=  pst.executeQuery();
            if(rs.next()){
                this.hide();
                ...
                String add5=rs.getString("EmailID");
                ...
                frm.cmbLevel.setSelectedItem(add7);
                String add9=rs.getString("Department");
                frm.cmbDepartment.setSelectedItem(add9);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentRegRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentRegRecord().setVisible(true);
            }
        });
    }
