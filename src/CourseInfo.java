...
PreparedStatement pst=null;
  ...
  con= Connect.ConnectDB();
    ...
    private void Get_Data(){
        String sql="select CourseName as 'Course Name',CourseCode as 'Course Code', Level, Department, Lecturer as 'Lecturer Name', CourseUnit as 'Course Unit' from course order by CourseName";
          try{
    ...
    private void initComponents() {
        ...
        CoursesTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Course Name", "Course Code", "Level", "Department", "Lecturer Name", "Course Unit"
            }
        ));
